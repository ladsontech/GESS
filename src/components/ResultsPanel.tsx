...
import { Battery, Zap, Clock, Box } from 'lucide-react';
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <div>Cost Effectiveness Score: {results.costEffectiveness.toFixed(2)}</div>
          <div>Energy Efficiency: {efficiency.toFixed(1)}%</div>
          <div>
            Expected degradation over {results.totalLifespan.toLocaleString()} cycles
          </div>
        </div>
      </div>
    </div>
